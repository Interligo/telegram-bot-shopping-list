...
# Обработка callback (удалить продукт), включает МС и считывает ввод пользователя
...
# Записывает наименование продукта и передает данные в функцию для удаления из БД
